            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="">@lang('form.label.login store')</p>

                        @include('store.auth.form_login')
                        ...
                        <p class="signup-link">@lang('not have account') <a href="{{route('store.register')}}">@lang('form.label.create new account')</a></p>
