<form class="text-left" method="post" action="{{route('store.register')}}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form">
        ...
        <div id="password-field" class="field-wrapper input mb-2">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{route('store.login')}}" class="forgot-pass-link">@lang('form.label.have account')</a>
            </div>
