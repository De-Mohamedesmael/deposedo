...
@if (auth('store')->user()->is_active)
    ...
    <a class="btn btn-danger d-block mt-2" href="{{route('store.home')}}">@lang('form.label.open site')</a>
@endif
        ...
        <div class="coming-soon-wrap">
            <div class="coming-soon-container">
                <div class="coming-soon-content">
                    ...
                    <a class="btn btn-danger d-block mt-2" href="{{route('store.logout')}}">@lang('form.label.logout')</a>
