...
<hr class="my-4">
<form class="mt-5" action="{{route('store.profile.updateImg')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="pl-lg-4">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="img-fluid mb-3"><img height="100" src="{{asset("assets/images/store/$auth->img")}}" alt=""></div>
            ...
            <div class="col-lg-12">
                ...
                <div class="img-fluid mb-3"><img height="100" src="{{asset("assets/images/store/$auth->cover")}}" alt=""></div>
