<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#dashboard" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-dashboard">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#accordionExample">
                    ...
                    <li id="li-sale">
                        <a href="{{route('admin.sale-report')}}">@lang('layout.sale_report')</a>
                    </li>
                    <li id="li-monthly-sale">
                        <a href="{{route('admin.monthly-sale')}}">@lang('layout.monthly_sale_report')</a>
                    </li>
                    <li id="li-daily-sale">
                        <a href="{{route('admin.daily-sale')}}">@lang('layout.daily_sale_report')</a>
                    </li>
                </ul>
            </li>
            ...
            {{--/////////// order///////////--}}
            <li class="menu">
                <a href="#orders" id="a-orders" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-orders">
                    <div class="">
            ...
            {{--/////////// cart///////////--}}
            <li class="menu">
                <a href="#carts" id="a-carts" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-carts">
                    <div class="">
                        <i class="fa-solid fa-list-check"></i>
                        <span>@lang('layout.carts')</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled" id="carts" data-parent="#accordionExample">
                    <li id="li-carts">
                        <a href="{{route('admin.carts.i.index')}}">@lang('layout.show carts')</a>
                    </li>
                </ul>
            </li>
            ...
            {{--/////////// section///////////--}}
            <li class="menu">
                <a href="#sections" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-sections">
                    <div class="">
            ...
            {{--/////////// المنتجات ///////////--}}
            <li class="menu">
                <a href="#products" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-products">
                    <div class="">
            ...
            {{--/////////// attributes ///////////--}}
            <li class="menu">
                <a href="#attributes" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-attributes">
                    <div class="">
            ...
            {{--/////////// colors ///////////--}}
            <li class="menu">
                <a href="#colors" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-attributes">
                    <div class="">
            ...
            {{--/////////// sizes ///////////--}}
            <li class="menu">
                <a href="#sizes" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-attributes">
                    <div class="">
                        <i class="fa fa-paint-brush" aria-hidden="true"></i>
            ...
            {{--/////////// options ///////////--}}
            <li class="menu">
                <a href="#options" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-options">
                    <div class="">
            ...
            {{--/////////// التقيمات ///////////--}}
            <li class="menu">
                <a href="#ratings" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-ratings">
                    <div class="">
            ...
            {{--/////////// المستخدمين ///////////--}}
            <li class="menu">
                <a href="#users" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-users">
                    <div class="">
            ...
            {{--/////////// الطلاب ///////////--}}
            <li class="menu">
                <a href="#student" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-student">
                    <div class="">
            ...
            {{--/////////// المسئولين ///////////--}}
            <li class="menu">
                <a href="#admins" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-admins">
                    <div class="">
                        <i class="fa fa-users" aria-hidden="true"></i>
            ...
            {{--/////////// الدول ///////////--}}
            <li class="menu">
                <a href="#countries" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-countries">
                    <div class="">
            ...
            <li class="menu">
                <a href="#areas" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-areas">
                    <div class="">
                        <i class="fa fa-globe" aria-hidden="true"></i>
                ...
                <ul class="collapse submenu list-unstyled" id="areas" data-parent="#accordionExample">
                    ...
                    <li id="li-areas">
                        <a href="{{route('admin.areas.indexYalidine')}}">@lang('layout.update_yalidine') </a>
                    </li>
                    <li id="li-create">
            ...
            <li class="menu">
                <a href="#currencies" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-currencies">
                    <div class="">
            ...
            {{--/////////// الصلاحيات ///////////--}}
            <li class="menu">
                <a href="#roles" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-roles">
                    <div class="">
            ...
            {{--/////////// قسائم الشراء ///////////--}}
            <li class="menu">
                <a href="#coupons" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-coupons">
                    <div class="">
            ...
            <li class="menu">
                <a href="#contact" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-contact">
                    <div class="">
            ...
            <li class="menu">
                <a href="#sliders" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-sliders">
                    <div class="">
            ...
            <li class="menu">
                <a href="#ads" data-toggle="collapse" data-active="false" aria-expanded="false" class="dropdown-toggle"
                   id="toggle-ads">
                    <div class="">
                        <i class="fa-solid fa-sliders"></i>
            ...
            <li class="menu">
                <a href="#icons" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-icons">
                    <div class="">
            ...
            {{-- page about --}}
            <li class="menu">
                <a href="#about" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-about">
                    <div class="">
            ...
            {{--/////////// notification ///////////--}}
            <li class="menu">
                <a href="#notification" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-notification">
                    <div class="">
                        <i class="fa-solid fa-list"></i>
            ...
            <li class="menu">
                <a href="#TermsAndConditions" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-TermsAndConditions">
                    <div class="">
                        <i class="fa fa-cogs" aria-hidden="true"></i>
            ...
            <li class="menu">
                <a href="#privacyPolicy" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-privacyPolicy">
                    <div class="">
                        <i class="fa fa-cogs" aria-hidden="true"></i>
            ...
            <li class="menu">
                <a href="#settings" data-toggle="collapse" data-active="false" aria-expanded="false"
                   class="dropdown-toggle" id="toggle-settings">
                    <div class="">
                        <i class="fa fa-cogs" aria-hidden="true"></i>
                ...
                <ul class="collapse submenu list-unstyled" id="settings" data-parent="#accordionExample">
                    <li id="li-settings">
                        <a href="{{route('admin.settings.index')}}">@lang('layout.settings')</a>
                    </li>
