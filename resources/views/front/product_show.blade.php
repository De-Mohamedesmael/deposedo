...
@section('style')
    ...
    <style>
       ...
       #design-product-data .is_order  label.t_brand_name {
        ...
        .select-att {
            border: 2px solid #124496 !important;
        }
    </style>
@endsection
@section('content')
    ...
    <div id="product-data-div">
        ...
        @if (!is_null($mainCategory))
            <a>
                <i class="fas fa-arrow-{{ app()->getLocale() == 'ar' ? 'left' : 'right' }} " style="font-size: 20px"></i>
            </a>

            <a href="{{ route('vendor', $mainCategory->id) }}">
        ...
        @if (!is_null($subCategory))
            ...
            <a href="{{ route('vendor', $subCategory->id) }}">
    ...
    <section id="design-parent">
      ...
      @endif
        ...
        <div class="col-md-6 col-12 pad-0" id="design-product-data" style="font-family: bein">
            ...
            <h5 style="height: 4vh;overflow:hidden">{!!\Illuminate\Support\Str::limit($result['description_' . app()->getlocale()], 50, '..')!!}</h5>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="prod-price">
                    @if ($result->if_sale)
                        <b>{{ get_price_helper($result->sale_price) }}</b>
                        <span class="regular_price">{{ get_price_helper($result->regular_price) }} </span>
                    @else
                        <b>{{ get_price_helper($result->regular_price) }}</b>
                    @endif
                </div>

                <p style="font-family: 'bein';color: #3fc0f0" class="d-flex">
            ...
            <form method="post" id="cart-form" name="cart_form" action="{{ route('add.cart.post') }}">
                ...
                <div class="d-flex justify-content-between mt-3">
                    <button type="submit" id="add_cart" style="background-color: #3fc0f0;cursor: pointer;
