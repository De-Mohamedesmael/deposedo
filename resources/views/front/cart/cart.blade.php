        ...
        <tr >
            <td >
              <a href="{{route("product",$product->id)}}">
                  <img alt="{{$product->name}}" src="{{asset('assets/images/products/min/'.$product->img)}}" width="100px;">
                </a>
              </td>
              <td >
                <p class="">
              ...
              <td >
                <span>{{get_price_helper($details['price'])}}</span>
              </td>
              ...
              <td class="subtotal text-center" data-title="SUBTOTAL">
                  ...
                  @endphp
                  <p class="x_sub_total_price_<?=$details["id"]?>_{{$key}}">{{get_price_helper($sum)}}</p>
              </td>
...
<p >{{__('site.Cart Subtotal')}}:<span id="total" class=" my_total styl-item-r">{{get_price_helper($total)}}</span></p><br>
<p >{{__('site.Shipping')}}:<span class=" styl-item-r ">{{__('site.Depend on city')}}</span></p><br>
<p >{{__('site.ORDER TOTAL')}}: <span class="  styl-item-r"> <span id="" class=" my_total styl-item-r">{{get_price_helper($total)}} </span>+ {{__('site.City shipping cost')}}</span></p><br>
<!--
