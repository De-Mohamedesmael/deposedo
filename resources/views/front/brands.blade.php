...
@section('content')
    ...
    <div class="container ">
        <div class="row m-2">
            <h1 class="col-md-12   main-color text-center">
                <img src="{{ asset('assets/images/student/' . $records->img) }}" width="50px;"> {{ $records->name }}
            </h1>
        </div>
    </div>
    {{-- @include('front.includes.ads_temp', ['items' => $ads->where('position', 9)]) --}}
    ...
    @include('front.includes.ads_temp', ['items' => $ads->where('position', 10)])
